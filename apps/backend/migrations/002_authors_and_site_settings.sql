-- 1. Запустити міграцію 002 вручну
ALTER TABLE users
...
CREATE TABLE IF NOT EXISTS site_settings (
                                             ...
                                             title         VARCHAR(300) NOT NULL DEFAULT 'Про нас | StackNova',
    name          VARCHAR(100) NOT NULL DEFAULT 'StackNova',
    description   TEXT,
    mission       TEXT,
...
SELECT
    'Про нас | StackNova', 'StackNova',
    'StackNova — це технічний блог про JavaScript, Backend, DevOps, AI та кібербезпеку.',
    'Наша місія — публікувати чіткі, практичні матеріали.',
    'hello@stacknova.dev',
    '2025-01-15'::date,
    '[{"name":"Twitter","url":"https://twitter.com/stacknova"},{"name":"GitHub","url":"https://github.com/stacknova"}]'::jsonb
    WHERE NOT EXISTS (SELECT 1 FROM site_settings);

-- 2. Оновити авторів з новими даними
UPDATE users SET
